	core u0 (
		...
		.freq_0_external_connection_export (<connected-to-freq_0_external_connection_export>), // freq_0_external_connection.export
		.freq_1_external_connection_export (<connected-to-freq_1_external_connection_export>), // freq_1_external_connection.export
		.freq_2_external_connection_export (<connected-to-freq_2_external_connection_export>), // freq_2_external_connection.export
		.freq_3_external_connection_export (<connected-to-freq_3_external_connection_export>), // freq_3_external_connection.export
		.freq_4_external_connection_export (<connected-to-freq_4_external_connection_export>), // freq_4_external_connection.export
		...
		.pwm_3_external_connection_export  (<connected-to-pwm_3_external_connection_export>),  //  pwm_3_external_connection.export
		.pwm_4_external_connection_export  (<connected-to-pwm_4_external_connection_export>),  //  pwm_4_external_connection.export
